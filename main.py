...
TOKEN = '7506889334:AAHLMAIWdJff7tNR_UaRVtKCN-bcXuiY3Jw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = 2091356843
CHANNEL_ID = 2091356843
error_channel_id = 2091356843
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: @Ariyan_ff*", parse_mode='Markdown')
